...
<!-- Mirrored from themesdesign.in/webadmin/layouts/tables-advanced.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Aug 2024 02:47:15 GMT -->
...
<head>
    ...
    <!-- gridjs css -->
    <link rel="stylesheet" href="assets/admin/libs/gridjs/theme/mermaid.min.css">
...
<body>
                                            ...
                                            <tbody>
                                                <?php foreach ($products as $product): ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $product->price ?></td>
                                                        <td>
                                                            <button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editProductModal" data-id="<?= $product->id ?>" data-name="<?= $product->name ?>" data-category="<?= $product->category ?>" data-price="<?= $product->price ?>">Edit</button>
    ...
    <script src="assets/admin/libs/metismenujs/metismenujs.min.js"></script>
    <script src="assets/admin/libs/simplebar/simplebar.min.js"></script>
    <script src="assets/admin/libs/eva-icons/eva.min.js"></script>

    <!-- gridjs js -->
    <script src="assets/admin/libs/gridjs/gridjs.umd.js"></script>

    <script src="assets/admin/js/pages/gridjs.init.js"></script>
...
<!-- Mirrored from themesdesign.in/webadmin/layouts/tables-advanced.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Aug 2024 02:47:16 GMT -->
