                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 mb-2">
                                <input id="searchKeyword" type="text" class="form-control"
                                    placeholder="Cari Data Administrator" autocomplete="off">
                            </div>
                                        ...
                                        foreach ($categories as $c): ?>
                                            <tr class="gradeX">
                                                ...
                                                <td class="hidden-phone">
                                                    ...
                                                    <a href="<?= site_url('admin/delete/' . $c['id']); ?>"
...
<div class="modal fade" id="modalAdd" tabindex="-1" role="dialog" aria-labelledby="modalAddTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="<?= site_url('admin/add'); ?>" method="post" class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalAddTitle">Tambah Administrator</h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="add_name">Email</label>
                    <input type="text" name="email_admin" id="add_name" class="form-control" required>
                </div>

                <!-- Slug -->
                <div class="form-group">
                    <label for="add_slug">Username</label>
                    <input type="text" name="username" id="add_slug" class="form-control">
                    <small class="text-muted"><font color="red">Password Otomatis : #@Admin4321</font></small>
                </div>
            </div>
