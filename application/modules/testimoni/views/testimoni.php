    ...
    <div class="modal fade" id="editTestimoniModal" tabindex="-1" aria-labelledby="editTestimoniModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?= base_url('testimoni/update_testimoni/' . (isset($testimoni->testimoni_id) ? $testimoni->testimoni_id : '')) ?>" method="POST" enctype="multipart/form-data">
                    <!-- Input hidden untuk testimoni_id -->
                    <input type="hidden" name="testimoni_id" value="<?= isset($testimoni->testimoni_id) ? $testimoni->testimoni_id : '' ?>">

                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="editTestimoniRate" class="form-label">Rate</label>
                            <input type="number" class="form-control" id="editTestimoniRate" name="rate" value="<?= isset($testimoni->testimoni_rate) ? $testimoni->testimoni_rate : '' ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="editTestimoniDesc" class="form-label">Description</label>
                            <textarea class="form-control" id="editTestimoniDesc" name="desc" required><?= isset($testimoni->testimoni_desc) ? $testimoni->testimoni_desc : '' ?></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="editTestimoniName" class="form-label">Name</label>
                            <input type="text" class="form-control" id="editTestimoniName" name="name" value="<?= isset($testimoni->testimoni_name) ? $testimoni->testimoni_name : '' ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="editTestimoniPlace" class="form-label">Place</label>
                            <input type="text" class="form-control" id="editTestimoniPlace" name="place" value="<?= isset($testimoni->testimoni_place) ? $testimoni->testimoni_place : '' ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="editTestimoniImage" class="form-label">Image</label>
                            <?php if (isset($testimoni->testimoni_images)): ?>
