                                ...
                                <div class="timeline-desk">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="album">
                                                <a href="#">
                                                    <img alt="" src="<?= base_url('assets/admin/') ?>img/sm-img-1.jpg">
                                                </a>
                                                <a href="#">
                                                    <img alt="" src="<?= base_url('assets/admin/') ?>img/sm-img-2.jpg">
                                                </a>
                                                <a href="#">
                                                    <img alt="" src="<?= base_url('assets/admin/') ?>img/sm-img-3.jpg">
                                                </a>
                                                <a href="#">
                                                    <img alt="" src="<?= base_url('assets/admin/') ?>img/sm-img-1.jpg">
                                                </a>
                ...
                <section class="card post-wrap pro-box">
                    ...
                    <aside class="post-highlight yellow v-align">
                        <div class="card-body text-center">
                            <div class="pro-thumb">
                                <img src="<?= base_url('assets/admin/') ?>img/ring.jpg" alt="">
                            </div>
                        </div>
                    </aside>
                </section>
                            ...
                            <div class="follower">
                                <div class="card-body">
                                    ...
                                    <div class="follow-ava">
                                        <img src="<?= base_url('assets/admin/') ?>img/follower-avatar.jpg" alt="">
                                    </div>
                                </div>
                            </div>
...
<div class="sb-slidebar sb-right sb-style-overlay">
    ...
    <ul class="quick-chat-list">
        <li class="online">
            <div class="media">
                <a href="#" class="">
                    <img alt="" src="<?= base_url('assets/admin/') ?>img/chat-avatar2.jpg" class="mr-3 rounded-circle">
                </a>
        ...
        <li class="online">
            <div class="media">
                <a href="#" class="">
                    <img alt="" src="<?= base_url('assets/admin/') ?>img/chat-avatar.jpg" class="mr-3 rounded-circle">
                </a>
                <div class="media-body">
        ...
        <li class="online">
            <div class="media">
                <a href="#" class="">
                    <img alt="" src="<?= base_url('assets/admin/') ?>img/pro-ac-1.png" class="mr-3 rounded-circle">
                </a>
                <div class="media-body">
                    <div class="media-status">
        ...
        <li class="online">
            <div class="media">
                <a href="#" class="">
                    <img alt="" src="<?= base_url('assets/admin/') ?>img/avatar1.jpg" class="mr-3 rounded-circle">
                </a>
                <div class="media-body">
        ...
        <li class="online">
            <div class="media">
                <a href="#" class="">
                    <img alt="" src="<?= base_url('assets/admin/') ?>img/mail-avatar.jpg" class="mr-3 rounded-circle">
                </a>
                <div class="media-body">
                    <div class="media-status">
